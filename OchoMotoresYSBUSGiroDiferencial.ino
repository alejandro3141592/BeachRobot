...
int velocidad_inferior = velocidad - 70;
void setup() {
  Serial.begin(115200);
...
void derecha() {
  ...
  motorController1.TurnLeft(velocidad);
  motorController2.TurnLeft(velocidad_inferior);
  motorController3.TurnLeft(velocidad);
  motorController4.TurnLeft(velocidad_inferior);
}

void izquierda() {

  motorController1.TurnLeft(velocidad_inferior);
  motorController2.TurnLeft(velocidad);
  motorController3.TurnLeft(velocidad_inferior);
  motorController4.TurnLeft(velocidad);
}
void alto() {
